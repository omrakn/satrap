...
* Choose the path where the road network of the area of interest and the result of the analysis is stored via 'Shapefile Output Folder' \n\
* Choose the path where the interactive map is stored via 'Interactive Map Output Path'. \n\
* Available transportation modes on OSM database are;\n\
    ...
    def saveWebmap(self):
        path = QtWidgets.QFileDialog.getSaveFileName(None, "Select Directory", "interactivemap.html", "HTML Files (*.html)")
    ...
    def retranslateUi(self, Frame):
        ...
        self.TransportationModeLabel.setText(_translate("Frame", "Transportation Mode (*)"))
        self.ShpOutputBrowse.setText(_translate("Frame", "Browse"))
        self.WebMapLabel.setText(_translate("Frame", "Interactive Map Output Path (*)"))
